...
export function CreatorBadge() {
  ...
  const handleWhatsAppClick = useCallback((e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    e.stopPropagation();
    // Security: construct URL in JS to prevent URL injection
    const phone = '393518924471';
    const msg = 'Ciao Trebla, ';
  ...
  return (
    <>
      {/* Floating button — same style as "Ascolta gli spoiler" */}
      <motion.button
        ...
        className="fixed bottom-5 right-5 z-50 px-4 py-2 bg-white/5 text-white font-semibold rounded-full text-sm border border-white/10 hover:bg-white/10 transition-all active:scale-95"
      >
        Clicca qui
      </motion.button>
            ...
            >
              ...
              <div className="relative z-10 px-10 pt-10 pb-8">
                ...
                <motion.p
                  ...
                  className="text-white/30 text-sm font-medium tracking-wide mb-5 whitespace-nowrap"
                >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#25D366]/15 border border-[#25D366]/30 text-[#25D366] text-sm font-semibold tracking-wide hover:bg-[#25D366]/25 hover:border-[#25D366]/50 transition-all duration-300 cursor-pointer"
                >
