import type { Artist, Spoiler } from '@/types';
...
export const artists: Artist[] = [
  {
    ...
    tracks: [
      { id: '1', title: 'Spoiler', artist: 'Orion', duration: '0:20', description: 'Anteprima del nuovo singolo' },
    ],
    spoiler: {
      videoFile: '/spoilers/orion.mp4',
      description: 'Spoiler 20 secondi - Anteprima del nuovo singolo',
    },
    socialLinks: {
  ...
  },
  {
    ...
    tracks: [
      { id: '1', title: 'Spoiler', artist: 'Blister', duration: '0:20', description: 'Anteprima inedito' },
    ],
    spoiler: {
      videoFile: '/spoilers/blister.mp4',
      description: 'Spoiler 20 secondi - Anteprima inedito',
    },
    socialLinks: {
  ...
  },
  {
    ...
    spoiler: {
      ...
      description: 'Spoiler 20 secondi - Vibes latine',
    },
    socialLinks: {
  ...
  },
  {
    ...
    tracks: [
      { id: '1', title: 'Spoiler', artist: 'LiCore', duration: '0:20', description: 'Prossimamente' },
    ],
    spoiler: {
      videoFile: '/spoilers/licore.mp4',
...
// Dati Pikete per la pagina contatti
export const piketeData = {
  name: 'Pikete',
  description: 'Pikete non è una band. È una label, un gruppo di amici che sanno fare musica. Quattro artisti, quattro visioni, una stessa famiglia.',
  email: 'piketelabel@gmail.com',
  socialLinks: {
    youtube: 'https://youtube.com/@pikete_pkt?si=vjJTQ7kz9Ct0Yr27',
    instagram: 'https://instagram.com/pikete_pkt', // DA AGGIORNARE
    tiktok: 'https://tiktok.com/@pikete_pkt', // DA AGGIORNARE
  },
};

// Spoiler per la pagina dedicata
export const spoilers: Spoiler[] = [
  {
    ...
    artistId: 'orion',
    videoFile: '/spoilers/orion.mp4',
    description: 'Trap melodica con vibe urbano-latino',
  },
  {
    id: 'blister-spoiler',
    title: 'Prossimo Uscita',
    artist: 'Blister',
    artistId: 'blister',
    videoFile: '/spoilers/blister.mp4',
    description: 'Rap tagliente, vibes scure',
  },
  {
    id: 'dysa-spoiler',
    title: 'In Arrivo',
    ...
    artistId: 'dysa',
    videoFile: '/spoilers/dysa.mp4',
    description: 'Reggaeton e trap melodica',
  },
  {
    id: 'licore-spoiler',
    title: 'Prossimamente',
    ...
    artistId: 'licore',
    videoFile: '/spoilers/licore.mp4',
    description: 'Rap classico, suono moderno',
    locked: true, // Il video non è ancora disponibile
  },
];
